    ...
    <div className="flex flex-col items-center justify-start min-h-screen bg-gradient-to-b from-blue-300 via-blue-500 to-blue-700 p-4">
      ...
      <div className="w-full max-w-md bg-blue-400/10 inset-shadow-sm rounded-lg p-8 shadow-lg">
        ...
        {/* <div className="flex justify-between gap-1">
          <button
            className="w-full py-3 gap-2 px-4 bg-white text-blue-500 rounded-lg font-medium flex items-center justify-center"
...
//         </div>
//       </div>
//       <div className="w-full max-w-md bg-blue-400 bg-opacity-30 backdrop-blur-sm rounded-lg p-8 shadow-lg">
//         <h1 className="text-3xl font-bold text-white text-center mb-8">
//           Setup my Business
//         </h1>
//         <div className="flex justify-center mb-6">
...
//         </div>
//         <button
//           className="w-full py-3 px-4 bg-white text-blue-500 rounded-lg font-medium flex items-center justify-center"
//           onClick={handleSubmit}
//           disabled={loading}
//         >
//           {loading ? "Processing..." : "Continue"}
